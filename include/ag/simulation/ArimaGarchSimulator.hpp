 ...
 * recursive process:
 *
 * 1. Generate standardized innovations z_t ~ N(0,1)
...
public:
     ...
     *    - Draws a standard normal innovation z_t
     ...
     */
    [[nodiscard]] SimulationResult simulate(int length, unsigned int seed) const;
